...
title: WaveMaker AI — A New Era of AI-Accelerated Application Development
description: WaveMaker AI introduces agent-driven development, design systems, and multi-mode workflows for modern application teams.
hide_title: true
---
...
>
  WaveMaker <span style={{ fontWeight: 900 }}>AI</span>
...
WaveMaker AI introduces [Design System](../../design-system/concepts/index.mdx) based approach for building UI applications.
...
WaveMaker AI introduces [Aira](../../developing-with-agents/concepts), an AI agent framework designed to assist across the application development lifecycle.
...
WaveMaker AI introduces [Auto Layout](../../user-interfaces/web/develop/working-with-layouts/auto-layout), a visual layout system for building structured and responsive UIs without writing CSS. It aligns with design-first thinking while giving developers precise control over layout behavior.
...
### Academy  
Now [WaveMaker Academy](https://academy.wavemaker.ai) evolves into a developer onboarding platform with mentor-led learning paths, and certification-oriented programs backed by latest videos explaining the development concepts.

### Component Storybook  
Detailed component documentation is now available through Storybook, enabling interactive exploration and live property manipulation for both web ([React](https://react-components.wavemaker.ai)) and mobile ([React Native](https://reactnative-components.wavemaker.ai)) components.

### Marketplace  
A new [Product Marketplace](https://marketplace.wavemaker.ai) being introduced to support reusable components, connectors, prefabs, design systems and industry-specific solutions.
